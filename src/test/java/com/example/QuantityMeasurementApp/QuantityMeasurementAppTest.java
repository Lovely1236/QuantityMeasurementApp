...
//Helper factory methods
    ...
    void testLengthAddition_DefaultUnit(){
        Quantity<LengthUnit> result = L(1, LengthUnit.FEET).add(L(12, LengthUnit.INCH));
    ...
    void testWeightConversion(){
        Quantity<WeightUnit> result = W(1, WeightUnit.KILOGRAM).convertTo(WeightUnit.GRAM);
        assertTrue(result.equals(W(1000, WeightUnit.GRAM)));
    }
    @Test
    void testWeightAddition_DefaultUnit(){
        Quantity<WeightUnit> result = W(1, WeightUnit.KILOGRAM).add(W(1000, WeightUnit.GRAM));
    ...
    void testZeroConversion(){
        Quantity<LengthUnit> zero =
                L(0, LengthUnit.FEET).convertTo(LengthUnit.INCH);
